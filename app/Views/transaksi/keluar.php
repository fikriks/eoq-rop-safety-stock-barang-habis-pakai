...
<?= $this->section('header') ?>Barang Keluar<?= $this->endSection() ?>
    ...
    <div class="col-12">
        ...
        <div class="card border-0 shadow-sm mb-4" style="border-radius: 12px;">
            <div class="card-body p-4">
                <form action="/transaksi/keluar" method="get" class="row align-items-end g-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4 d-flex gap-2">
                        ...
                        <a href="/transaksi/keluar" class="btn btn-light border px-4" style="height: 42px;">
        ...
        <div class="card border-0 shadow-sm" style="border-radius: 12px;">
            <div class="card-header bg-white border-bottom-0 py-4 px-4 d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="m-0 fw-800 text-dark" style="letter-spacing: 0.5px;">RIWAYAT PENGGUNAAN</h6>
                    <p class="small text-muted mb-0">Menampilkan data barang keluar berdasarkan filter yang dipilih.</p>
                </div>
                <div class="d-flex gap-2">
                    ...
                    <button type="button" class="btn btn-dark px-3 shadow-sm fw-bold" data-bs-toggle="modal" data-bs-target="#modalTambah">
                        <i class="bi bi-plus-lg me-2"></i>Tambah Keluar
                    </button>
                </div>
            </div>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        <thead>
                            <tr class="bg-light">
                                ...
                                <th class="py-3 border-0 text-muted small fw-800">PENERIMA / KET</th>
                                ...
                                <tr>
                                    <td colspan="5" class="text-center py-5">
                                        <div class="py-4">
                                            ...
                                            <p class="text-muted fw-bold">Tidak ada data transaksi keluar.</p>
                                        </div>
                                    </td>
                                </tr>
                            <?php else: ?>
                                <?php foreach ($transaksi as $item): ?>
                                    <tr class="border-bottom" style="border-color: #f1f1f1 !important;">
                                        ...
                                        <td class="text-center">
                                            <span class="badge bg-soft-danger text-danger border-0 px-3 py-2 fw-800" style="background-color: #fbe9e7; font-size: 0.85rem;">-<?= $item['jumlah'] ?></span>
                                        </td>
                                        <td class="small fw-600 text-muted"><?= $item['keterangan'] ?: '-' ?></td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 16px;">
            <div class="modal-header border-0 pt-4 px-4">
                <h6 class="modal-title fw-800 text-uppercase text-primary"><i class="bi bi-file-earmark-excel me-2"></i>Import Barang Keluar</h6>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <form action="/transaksi/import-keluar" method="post" enctype="multipart/form-data">
                <?= csrf_field() ?>
                <div class="modal-body px-4">
                    <div class="alert bg-light border-0 small mb-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <a href="/template/transaksi-keluar" class="btn btn-sm btn-link text-decoration-none fw-bold p-0"><i class="bi bi-download me-1"></i>Download Template</a>
                        </div>
                        <ol class="mb-0 fw-600 text-muted">
                            <li>Nama Barang (Harus sesuai Master Barang)</li>
                            <li>Jumlah</li>
                            <li>Tanggal (Format: YYYY-MM-DD)</li>
                            <li>Keterangan / Penerima</li>
                        </ol>
                    </div>
                    <div class="mb-3">
...
<div class="modal fade" id="modalTambah" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 16px;">
            <div class="modal-header border-0 pt-4 px-4">
                <h6 class="modal-title fw-800 text-uppercase text-dark"><i class="bi bi-plus-lg me-2"></i>Tambah Barang Keluar</h6>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <form action="/transaksi/simpan" method="post">
                ...
                <div class="modal-body px-4">
                    ...
                    <div class="mb-3">
                        <label class="form-label small fw-800 text-muted uppercase">Penerima / Keterangan</label>
                        <textarea name="keterangan" class="form-control" rows="2" placeholder="Contoh: Sie Umum - Subag Tata Usaha"></textarea>
                    </div>
                </div>
                <div class="modal-footer border-0 pb-4 px-4">
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content border-0 shadow-lg text-center" style="border-radius: 16px;">
            <div class="modal-body p-4">
                ...
                <p class="small text-muted mb-4">Anda akan menghapus transaksi keluar <br><strong id="del_nama" class="text-dark"></strong> sebanyak <strong id="del_jumlah" class="text-dark"></strong></p>
